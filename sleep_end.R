...
# In analysR, this function is called on each column of five_min_bouts, 
# which by itself represents each individual channel used in the experiment. 
# sleep_end uses a sliding window of length 2 and slides down the input vector until it encounters
